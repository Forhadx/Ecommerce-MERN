  ...
  return (
    <div className="products__filter">
      <div className="products__filter--category">
        <label className="products__filter--category-main">Main Category</label>
        ...
        <label className="products__filter--category-sub">Sub Category</label>
